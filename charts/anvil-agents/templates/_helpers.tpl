...
{{- if and .Values.api.chatDatabaseURLSecret .Values.api.chatDatabaseURLSecret.name -}}
...
{{- end -}}
{{- if and .Values.api.chatDatabaseURLSecret .Values.api.chatDatabaseURLSecret.name (not $chatEnabled) -}}
