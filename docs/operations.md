...
Back up all fourteen custom-resource kinds and relevant PVCs before an upgrade.
...
`make kind-upgrade-e2e` proves a portable eight-CRD, legacy-object baseline can
be upgraded to the current fourteen-CRD chart while retaining profiles and runs. It
