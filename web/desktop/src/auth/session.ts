...
const ACCESS_KEY = "anvil-agents-desktop.accessToken";
const REFRESH_KEY = "anvil-agents-desktop.refreshToken";
const EXPIRES_KEY = "anvil-agents-desktop.expiresAt";
...
const LEGACY_TOKEN_KEY = "anvil-agents-desktop.bearerToken";
