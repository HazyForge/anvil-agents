...
interface Props {
  /** Complete (archived/historical) run or chat prose. Never raw HTML. */
  content: string;
  className?: string;
}
...
// Sanitized GFM rendering for console run prose and standing-chat archives.
...
//
// Streaming note: run detail and chat threads render complete persisted
// records, not token streams, so progressive rendering is the less janky
// choice — react-markdown tolerates partial fences/lists while a turn is
// still running. Live log streams (LiveStream) stay plain text.
