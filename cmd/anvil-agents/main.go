...
func main() {
	...
	flag.StringVar(&options.SubstrateEndpoint, "substrate-endpoint", options.SubstrateEndpoint, "Substrate lifecycle gateway origin for live actor dispatch (Kind-local for the spike). Empty keeps the SubstrateActor hold.")
