...
func main() {
	...
	flag.BoolVar(&options.SubstrateInsecure, "substrate-insecure", options.SubstrateInsecure, "Dial ateapi over plaintext gRPC for a local Kind port-forward. Kind-only: non-loopback endpoints are refused.")
